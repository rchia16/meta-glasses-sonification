...
data class StreamUiState(
    ...
    val isObjectSonificationEnabled: Boolean = false,
    val onlySonificationLabel: String? = null,
    val isSceneSegmentationSonificationEnabled: Boolean = false,
    val onlySceneSonificationLabel: String? = null,
    val availableSceneClassLabels: List<String> = SceneClass.values().map { it.label },
    val isNorthCueEnabled: Boolean = false,
    val northAudioMode: NorthFeedbackMode = NorthFeedbackMode.CALM,
    val isNorthHapticEnabled: Boolean = false,
    val northHapticMode: NorthFeedbackMode = NorthFeedbackMode.CALM,
